...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 30, 2025 at 01:08 AM
...
(16, 1, 53, 13, 1, 1, 'DELA CRUZ, JUAN', '20', '2', '2', 'Male', '09123723812', 2025, 'FINANCE', '24242424', '2025-09-30', '2025-10-01', NULL, 'asd@gmail.com', '2025-10-18', '2025-10-19', 'Yes', 22, 12321123, '2028-11-20'),
(18, 45, 33, NULL, 1, 1, 'PEREZ, MARIA CLARA', '14', '2', '2', 'Female', '09123723812', 2025, 'FINANCE', '24242424', '2025-09-28', '2025-09-29', NULL, 'asd@gmail.com', '2025-10-16', '2025-10-17', '0', NULL, NULL, NULL),
...
(20, 29, 6, NULL, 1, 2, 'PEREZ, MARIA CLARA', '', '2', '2', 'Male', '2222222222', 22, 'MEDICAL', NULL, NULL, NULL, NULL, 'asd@gmail.com', NULL, NULL, '1', NULL, NULL, NULL);
...
(122, 16, 'Achieving High Standards'),
(125, 18, 'Accounting Proficiency'),
(126, 18, 'Achieving High Standards'),
(129, 19, 'Accounting Proficiency'),
(130, 19, 'Achieving High Standards'),
(133, 20, 'Accounting Proficiency'),
(134, 20, 'Achieving High Standards');
...
(108, 16, 'Accounting Proficiency'),
(110, 18, 'Accounting Proficiency'),
(112, 19, 'Accounting Proficiency'),
(114, 20, 'Accounting Proficiency');
...
(41, 16, 'ddccccccz', '', '', '', '', NULL),
(43, 18, 'ddcccccczcc', 'zxcxc', 'ccwcd', 'xc', 'cc', '2028-11-15'),
(45, 19, 'ddcccccczcc', 'zxcxc', 'ccwcd', 'xc', 'cc', '2028-11-14'),
(47, 20, 'ddccccccz', '', '', '', '', NULL);
...
--
ALTER TABLE `employee_ca_description`
  MODIFY `empd_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `employee_ca_gap`
--
ALTER TABLE `employee_ca_gap`
  MODIFY `empg_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=135;

--
-- AUTO_INCREMENT for table `employee_ca_strength`
--
ALTER TABLE `employee_ca_strength`
  MODIFY `emps_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;

--
-- AUTO_INCREMENT for table `employee_ldplan`
--
ALTER TABLE `employee_ldplan`
  MODIFY `empl_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
