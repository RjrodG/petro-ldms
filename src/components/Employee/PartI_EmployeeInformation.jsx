        ...
        <form onSubmit={handleSave}>
          ...
          <div className="idp-tab-control">
            <div className="idp-tabs">
              ...
              <button
                type="button"
                className={selectedTab === 'ld' ? 'idp-tab active' : 'idp-tab'}
                onClick={() => setSelectedTab('ld')}
              >
                LD & Non-LD
              </button>
              <button
                type="button"
                className={selectedTab === 'official' ? 'idp-tab active' : 'idp-tab'}
                onClick={() => setSelectedTab('official')}
              >
                Official Time & Official Business
              </button>
            </div>
            <div className="idp-tab-content">
              ...
              {selectedTab === 'ld' && (
                <div style={{padding: '2rem', textAlign: 'center', color: '#888'}}>LD & Non-LD content goes here.</div>
              )}
              {selectedTab === 'official' && (
                <div style={{padding: '2rem', textAlign: 'center', color: '#888'}}>Official Time & Official Business content goes here.</div>
              )}
            </div>
          </div>
